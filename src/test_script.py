...
from src.models import AdaptiveLinearModel, BehaviouralCloning  # noqa: F401
from src.data_loading import generate_linear_dataset
...
validation_data = generate_linear_dataset(100, 50, seed=41311).get_whole_batch()
