...
ax.plot(x, density(x), label="Y +ive, A = 1", color="blue")
ax.plot(x, density2(x), label="Y -ive, A = 1", color="orange")
ax.plot(x, density3(x), label="Y +ive, A = 0", color="green")
ax.plot(x, density4(x), label="Y -ive, A = 0", color="red")
"""
